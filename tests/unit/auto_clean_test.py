...
DATETIME_META = {'datetime': 0.75, 'datetime_error': 0.25, 'int': 0.25, 'int_error': 0.75, 'float': 0.25,
    'float_error': 0.75, 'bool': 0, 'bool_error':1}

INT_META = {'datetime': 0.0, 'datetime_error': 1.0, 'int': 0.75, 'int_error': 0.25, 'float': 0.75, 'float_error': 0.25,
    'bool': 0.0, 'bool_error': 1.0}

FULL_INT_META = {'datetime': 0.0, 'datetime_error': 0, 'int': 1, 'int_error': 0, 'float': 0, 'float_error': 0,
    'bool': 0.0, 'bool_error': 0, 'exact_type': 'UInt32', 'general_type':'int'}

FLOAT_META = {'datetime': 0.0, 'datetime_error': 1.0, 'int': 0.25, 'int_error': 0.75, 'float': 0.75,
    'float_error': 0.25, 'bool': 0.0, 'bool_error': 1.0}

STRING_META =  {'datetime': 0.0, 'datetime_error': 1.0, 'int': 0.0, 'int_error': 1.0, 'float': 0.25,
    'float_error': 0.75, 'bool': 0.0, 'bool_error': 1.0}

DATETIME_EDGECASE_META = {'datetime': 1.0, 'datetime_error': 1.0, 'int': 0.0, 'int_error': 1.0, 'float': 0.0,
    'float_error': 1, 'bool': 0.0, 'bool_error': 1.0}
...
ONLY_NANS_META = {'datetime': 0, 'datetime_error': 0, 'int': 0, 'int_error': 0, 'float': 0, 'float_error': 0, 'bool': 0,
    'bool_error': 0}
