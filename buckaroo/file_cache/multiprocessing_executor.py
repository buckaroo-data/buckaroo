...
class MultiprocessingExecutor(BaseExecutor):
    ...
    """
    def __init__(self, ldf: pl.LazyFrame, column_executor: ColumnExecutor, listener: ProgressListener, fc: FileCache,
            executor_log: Optional[SimpleExecutorLog] = None, file_path: MaybeFilepathLike = None,
            timeout_secs: float = 30.0, async_mode: bool = True,
            cached_merged_sd: dict[str, dict[str, Any]] | None = None, orig_to_rw_map: dict[str, str] | None = None,
