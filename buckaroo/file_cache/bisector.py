...
def full_bisect_pipeline(ldf: pl.LazyFrame,
    ...
    starting_event = ExecutorLogEvent(
        dfi=(id(ldf), ''),
        args=starting_args,
        start_time=now(),
        end_time=None,
    ...
    expr_start_event = ExecutorLogEvent(
        dfi=(id(ldf), ''),
        args=failing_args,
        start_time=now(),
        end_time=None,
    ...
    try:
        ...
        failing_expr_args = ExecutorArgs(
            ...
            row_end=None,
            extra={})
        row_event_for_success = ExecutorLogEvent(
            dfi=(id(ldf), ''),
            args=failing_expr_args,
            start_time=now(),
            end_time=None,
            completed=False)
    ...
    minimal_fail_expr_args = ExecutorArgs(
        ...
        row_end=None,
        extra={})
    row_event = ExecutorLogEvent(
        dfi=(id(ldf), ''),
        args=minimal_fail_expr_args,
        start_time=now(),
        end_time=None,
        completed=False)
