...
from .serialization_utils import sd_to_parquet_b64, make_infinite_resp
...
class LazyInfinitePolarsBuckarooWidget(anywidget.AnyWidget):
    ...
    def _handle_payload_args(self, new_payload_args: Dict[str, Any]) -> None:
        ...
        try:
            ...
            self.send(*make_infinite_resp(new_payload_args, self.df_meta['total_rows'],
            ...
            if second_pa:
                ...
                if s2 is not None and e2 is not None:
                    ...
                    self.send(*make_infinite_resp(second_pa, self.df_meta['total_rows'],
