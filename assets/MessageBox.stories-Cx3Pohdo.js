import{j as c}from"./jsx-runtime-DiklIkkE.js";import{r as p}from"./index-DRjF_FHU.js";import{a as Q}from"./DFViewerInfinite-BwKijvy4.js";/* empty css                */import"./gridUtils-LxDV4unU.js";import"./main.esm-C6PYKVYP.js";import"./_baseEach-B-y44WsN.js";import"./isArray-Dxzbedgu.js";import"./HistogramCell-qbNrk3qL.js";import"./index-DIvcuAjW.js";import"./ChartCell-DjlNlKxO.js";import"./tiny-invariant-CopsF_GD.js";import"./isString-CNnovG4X.js";import"./index.esm-D_s6Kf8n.js";function M({messages:s}){const[e,i]=p.useState(0),r=p.useRef(0),m=p.useMemo(()=>{if(!s||s.length===0)return r.current!==0&&(r.current=0,i(t=>t+1)),[];const a=s.map((t,n)=>!t||typeof t!="object"?{index:n,time:"",type:"",message:String(t||"")}:{index:n,time:t.time||"",type:t.type||"",message:t.message||"",...Object.fromEntries(Object.entries(t).filter(([u])=>!["time","type","message"].includes(u)))});return s.length!==r.current&&(r.current=s.length,i(t=>t+1)),a},[s]),S=p.useMemo(()=>{if(!s||s.length===0)return{pinned_rows:[],column_config:[],left_col_configs:[{col_name:"index",header_name:"index",displayer_args:{displayer:"obj"}}]};const a=new Set;s.forEach(n=>{n&&typeof n=="object"&&Object.keys(n).forEach(u=>a.add(u))}),a.add("index"),a.add("time"),a.add("type"),a.add("message");const t=Array.from(a).map(n=>({col_name:n,header_name:n,displayer_args:{displayer:"obj"}}));return{pinned_rows:[],column_config:t,left_col_configs:[{col_name:"index",header_name:"index",displayer_args:{displayer:"obj"}}]}},[s]),o=()=>{};return!s||s.length===0?null:c.jsx("div",{style:{height:"300px",width:"100%",border:"1px solid red",marginTop:"10px",backgroundColor:"#1a1a1a"},children:c.jsx(Q,{data_wrapper:{data_type:"Raw",data:m,length:m.length},df_viewer_config:S,summary_stats_data:[],activeCol:["",""],setActiveCol:o,error_info:""},`df-viewer-${e}-${m.length}`)})}M.__docgenInfo={description:"",methods:[],displayName:"MessageBox",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    time?: string;
    type?: string;
    message?: string;
    [key: string]: any;
...
}`,...(N=(F=y.parameters)==null?void 0:F.docs)==null?void 0:N.source}}};const le=["Empty","CacheMessages","CacheInfo","ExecutionUpdates","MixedMessages","ManyMessages","LongMessages","StreamingMessages"];export{d as CacheInfo,l as CacheMessages,g as Empty,_ as ExecutionUpdates,x as LongMessages,f as ManyMessages,h as MixedMessages,y as StreamingMessages,le as __namedExportsOrder,ge as default};
