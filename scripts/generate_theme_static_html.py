...
def multiindex_df():
    ...
    return pd.DataFrame([[1.2, 1.4, 1.8, 45, 12, 8], [0.9, 1.1, 1.3, 30, 8, 5], [2.1, 2.5, 3.0, 80, 20, 15],
        [0.5, 0.6, 0.7, 15, 5, 3], [3.4, 3.8, 4.2, 120, 35, 22]],
        index=pd.Index(
            ["ACME Corp", "Widgets Inc", "MegaTech", "StartupCo", "BigData Ltd"]), columns=cols)
...
THEME_ENTRIES = [
    ...
    ("accent-color", "Custom Accent Color", {"accentColor": "#ff6600", "accentHoverColor": "#cc5200"}, "Override the accent color used for column selection highlights and interactive elements."),
    ("ocean-dark", "Ocean Dark", {"colorScheme": "dark", "accentColor": "#00bcd4", "accentHoverColor": "#0097a7",
        "backgroundColor": "#0a1628", "foregroundColor": "#b0bec5", "oddRowBackgroundColor": "#0d2137",
        "borderColor": "#1a3a5c"}, "A deep ocean-inspired dark theme with cyan accents."),
    ("warm-light", "Warm Light", {"colorScheme": "light", "accentColor": "#e65100", "accentHoverColor": "#bf360c",
        "backgroundColor": "#fff8f0", "foregroundColor": "#3e2723", "oddRowBackgroundColor": "#fff3e0",
        "borderColor": "#ffe0b2"}, "A warm, earthy light theme with orange accents."),
    ("neon-dark", "Neon Dark", {"colorScheme": "dark", "accentColor": "#e91e63", "accentHoverColor": "#c2185b",
    ...
    ("forest-dark", "Forest Dark", {"colorScheme": "dark", "accentColor": "#66bb6a", "accentHoverColor": "#43a047",
        "backgroundColor": "#1b2a1b", "foregroundColor": "#c8e6c9", "oddRowBackgroundColor": "#223322",
        "borderColor": "#2e7d32"}, "A dark theme with forest green accents — easy on the eyes for long sessions."),
    ("minimal-light", "Minimal Light", {"colorScheme": "light", "accentColor": "#9e9e9e", "accentHoverColor": "#757575",
        "backgroundColor": "#ffffff", "foregroundColor": "#212121", "oddRowBackgroundColor": "#fafafa",
        "borderColor": "#e0e0e0"}, "A neutral, low-contrast light theme that keeps data front and center."),
    ("high-contrast", "High Contrast", {"colorScheme": "dark", "accentColor": "#ffff00", "accentHoverColor": "#ffd600",
        "backgroundColor": "#000000", "foregroundColor": "#ffffff", "oddRowBackgroundColor": "#1a1a1a",
    ...
    ("spacious", "Spacious Layout", {"colorScheme": "dark", "accentColor": "#7c4dff", "accentHoverColor": "#651fff",
        "spacing": 10, "rowVerticalPaddingScale": 1.2, "cellHorizontalPaddingScale": 0.8,
        "headerBorderColor": "#7c4dff"}, "Increased spacing, padding, and a purple header border for a more airy layout."),
    ("compact", "Compact Layout", {"colorScheme": "light", "spacing": 2, "rowVerticalPaddingScale": 0.2,
        "cellHorizontalPaddingScale": 0.15, "headerBorderColor": "#bdbdbd"}, "Minimal spacing for maximum data density — fits more rows on screen."),
    ("vc-pricing", "VC Pricing Page", {"colorScheme": "light", "accentColor": "#6c5ce7", "accentHoverColor": "#5a4bd1",
