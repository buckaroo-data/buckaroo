...
df = pd.DataFrame({'name': ['Alice', 'Bob', 'Charlie', 'Diana', 'Eve',
    'Frank', 'Grace', 'Hank', 'Ivy', 'Jack'], 'age': [
        ...
        47], 'score': [
            ...
            73.6,
            85.9,
            90.4], 'active': [True, False, True, True, False, True, True, False, True, False]})
...
bigint_df = pd.DataFrame({'big_id': [9007199254740993, 9007199254740994, 9007199254740995], 'label': ['a', 'b', 'c']})
